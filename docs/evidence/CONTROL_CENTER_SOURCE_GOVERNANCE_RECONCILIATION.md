...
Prepared source DOCX files are maintained as Project artifacts; repository implementation evidence references this decision but does not replace the authoritative source documents.
