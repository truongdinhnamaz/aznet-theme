...
- Current canonical Law 01 / client-delivery technical baseline: owner-approved About presentation PR #196 merged to `main@aab636d3fe1c21be924ba62ea30b7a910cf2e019`; owner-approved release PR #197 then promoted Theme metadata to `1.3.21` and merged to canonical `main@998a8dcf342b09824b197059524c50c013dba828`. Fresh exact-main V1 run `35518082825` and X6 run `35518082833` both completed SUCCESS. X6 browser/axe matrix passed 32/32 and rebuilt `aznet-theme-1.3.21.zip` twice byte-identically: 158 package files, 113 packaged PHP lint PASS, SHA-256 `da695f2b33aafc38172a9a412a3b1afd16263db3f03d305be4304eba877e09e2`; exact-main X6 artifact `10607616743` has digest `sha256:beacf4a2d8bc6abf0c0b1f8453822c3aa3a3fcee99e7ca4aad4611b25917e655`. Evidence: `docs/evidence/V1_3_21_ABOUT_PAGE_TECHNICAL_CLOSURE_20260920.md`.
...
- Current published GitHub Release is `v1.3.20`: annotated tag object `f7d50863b3b7b8f4e500172ba624d24b73ff312f` dereferences to exact canonical implementation `a81067b1f1804783a35e8113ebf6859c7fcc38fa`; Release `392420684`; asset `576757385` `aznet-theme-1.3.20.zip`, SHA-256 `96ff01960e17d1da7167c5c3e296abbdabad0e5d51603f0f73ca4513ac880c00`. Publication run `35509995234` completed SUCCESS; evidence artifact `10605040189` digest `sha256:e6852b61a14c176db5f7da28c063fe204140cdeeba4eb8440902bc2cd91a52b8`. Evidence: `docs/evidence/LAW01_HOMEPAGE_FINAL_PASS_20260920.md`.
- Current production target remains `lstamduchn.vn`. No `1.3.21` production deployment is claimed. The most recent secure target-site access evidence remains **BLOCKED_EXTERNAL_ACCESS** before WordPress authentication: TCP/443 connected but TLS stalled after ClientHello. Production remained unmodified. Fresh live Theme version remains UNKNOWN and `1.3.10` remains only the last verified live state until a secure authenticated read path succeeds. The owner has removed WPVibe as a dependency for repository technical/release verification; this does not waive production preflight, rollback or authenticated target-site verification.
...
- Historical published release `v1.3.10` remains preserved at its recorded exact identity in `docs/evidence/V1_3_10_PUBLICATION_20260919.md`; it was superseded as the current GitHub Release by owner-approved `v1.3.11` and then `v1.3.12`. Current publication identity is recorded above and in `docs/evidence/V1_3_12_PUBLICATION_20260919.md`.
...
The owner reported that the Law 01 Hero still looked boxed against the full-width page background. The accepted correction keeps the shared 96rem content shell but removes the separately painted text panel and lets the image surface bleed naturally to the viewport edge. On stacked/mobile layouts the image surface bleeds to both viewport edges without horizontal overflow.

Visual RED head `ffd2c8e48498bf0849ec8fa022feddb52da80806` failed the intended contract that the Hero text column must not paint its own boxed background. Minimal visual GREEN changed only the Burgundy Hero presentation surface. A stale retained browser ratio was then corrected to measure the 48% content column against the shared grid rather than the bleeding image width. Exact visual head `8cf81cb0ec7955d7605e32913aa36af7fe31b20d` completed **14/14 triggered workflows SUCCESS**. Browser run `35405740629`; artifact `10572278488`, digest `sha256:819160a4b0dd17ae729794c585612791fde1fe07fc2c8b5da54f3faffa1cd406`.

Because Theme 1.3.8 is already canonical and already has a deterministic package identity, the improved bytes are promoted to 1.3.9 rather than reissuing different bytes as 1.3.8. Release RED head `886c3d751326d16a90bddfa54bcaafa7b9af31d4` failed the intended Y5 assertion `Y5 promoted style.css must be exactly 1.3.9`. Minimal release GREEN changed only `style.css` and `AZNET_THEME_VERSION` and extended Y5/X6 guards for the exact `1.3.8 -> 1.3.9` promotion boundary.

Exact production head `b4ead6ea541074fa76b1657d20de07828c5bfde9` completed **19/19 triggered workflows SUCCESS, 0 failure**. Y5 produced deterministic `aznet-theme-1.3.9.zip`, 145 production files, 108/108 packaged PHP lint PASS, SHA-256 `33a70a1d63ae96c21d6efe381f8a0fea299ac0c14a49df56c5edfe8c2eb9404a`. Run `35406199947`; promoted-package artifact `10571874751`, digest `sha256:892e96890c189950000367c886bccd70b697de6c0ed442bcbb3527480ae7d9d9`.

Canonical `main` remains Theme metadata 1.3.8 until PR #150 is merged. Tag/GitHub Release and production deployment are not claimed. Evidence: `docs/evidence/V1_3_9_SEAMLESS_HERO_CLIENT_DELIVERY_20260919.md`.
...
### AZnet Theme 1.3.15 publication closure — 20/09/2026

Owner-approved publication run `35474494290` completed SUCCESS from temporary branch `ops/publish-v1.3.15`. The workflow checked out exact verified implementation `6cf48d1653d6468ec5aa25761c1a5b1dc82d4aa3`, rebuilt `aznet-theme-1.3.15.zip` twice at byte-identical SHA-256 `8f91e9bd3a40a7eae4e6984a77f2735f339d188e52cfc6f97fac57a96bfcecd8`, verified 148 production files and 111 packaged PHP files, created annotated tag `v1.3.15`, published GitHub Release `392243619`, then downloaded and rehashed public asset `575623879` to the same digest.
