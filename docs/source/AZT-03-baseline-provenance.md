...
- Canonical repository technical baseline is Theme version `1.3.0` at owner-approved PR #98 merge `main@afa8f4eb80d83d6c8111a9dc1bc57c13c6e24b8e`, tree `020db34ca6f360d5af12e6f15abf4c9ba51179f0`; v1.3 technical closure is PASS and owner-approved publication is now PASS.
...
- Published/GitHub-Release release is now `v1.3.0`: owner-approved publication run `35211254633` published annotated tag `v1.3.0` (tag object `56f2ae2e8ba6e1fb4e8359447656e88ab6411ba6`) dereferencing to exact technical commit `afa8f4eb80d83d6c8111a9dc1bc57c13c6e24b8e`, GitHub Release `390623960`, and asset `570039299` (`aznet-theme-1.3.0.zip`) with SHA-256 `4a30001f04dbbb881b8bfb01099e2caa4c8d01eafbca686ab934c0b2c12f105e`; publication evidence artifact `10492411096` has digest `sha256:0a18d2169ad8d92a587421289ede773031e56d3646ddac44ba326ebe4ea6fd75`. Production-deployed release remains `v1.2.0` on `tamduchanoi.aznet.vn`; v1.3 production deployment remains a separate owner gate. Provider L5 remains unproven. Evidence: `docs/evidence/V1_3_PUBLICATION_20260917.md`.
- WordPress floor: `6.9+`.
- PHP floor: `8.1+`.
...
- v1.2.0 publication and owner-approved production deployment are now complete at the verified Theme-owned/site-operations scope. Deployment run `35135759389` installed the exact published `1.2.0` package and assigned the existing WordPress-owned menu ID `15` to the new `header-utility` location; fresh independent read-only run `35136876330` reverified active Theme `1.2.0`, Standalone Core `ready`, retained logo/menu identity and a 28/28 public regression with zero Theme-owned blocker. Provider L5 remains separate and unproven.
...
- v1.1.0 publication/deployment remain retained historical PASS; current published release and verified production Theme on `tamduchanoi.aznet.vn` are `1.2.0` at their respective verified scopes.
- v1.2 X1-X5 functional closure is retained; X6 technical integration, exact-main/package verification, publication and production deployment are all PASS at their separately verified scopes.
- The former X6 candidate state has been superseded by canonical merge, `v1.2.0` publication and owner-approved production deployment PASS; provider L5 remains separate and is not inferred.
- Provider L5 is outside v1.2 Core and is not inferred from X6 technical candidate PASS.
...
**NEXT — the v1.2.0 Core release path is closed at PUBLICATION + PRODUCTION DEPLOYMENT PASS. No new Theme milestone, architecture/public-contract change or optional-provider certification begins without a new approved slice; provider L5 remains separate.**
...
P5 technical state is therefore **TECHNICAL CANDIDATE PASS / PUBLICATION GATED** at its historical pre-publication checkpoint. Later owner-approved publication and production deployment closed v1.1; that later closure does not authorize v1.2 publication/deployment.
