...
- Current canonical Law 01 / client-delivery technical baseline: owner-approved PR #171 final head `275c4ad03b59c93c5a8a063a291137bf48a2ac11` completed 22/22 exact-head checks SUCCESS and merged to `main@ac5f6a41122f11bfdf334a8e080532f6165aa120`, Theme metadata `1.3.16`. Fresh exact-main V1 run `35477748238` and X6 run `35477748216` both completed SUCCESS. Deterministic `aznet-theme-1.3.16.zip` SHA-256 is `7d6798077bfa0dfcda5e770c31df5e89ff00cc82c4686d3256e9897a3959e431`, 148 production files, 111 packaged PHP files. Evidence: `docs/evidence/V1_3_16_TECHNICAL_CLOSURE_20260920.md`.
...
- Current published GitHub Release is `v1.3.16`: annotated tag object `2196d9248c15000eecd2bc5334499a3445ab427a` dereferences to exact verified implementation `ac5f6a41122f11bfdf334a8e080532f6165aa120`; Release `392259635`; asset `575729964` `aznet-theme-1.3.16.zip`, 148 production files, 111 packaged PHP files, SHA-256 `7d6798077bfa0dfcda5e770c31df5e89ff00cc82c4686d3256e9897a3959e431`. Owner-approved publication run `35478013102` completed SUCCESS; artifact `10594348675` digest `sha256:a6443d2d70d3d5e05e6dc6a423247a7e84cccc1f79355d87e7ba61ec008e319a`. Evidence: `docs/evidence/V1_3_16_PUBLICATION_20260920.md`.
- Current production target remains `lstamduchn.vn`. No `v1.3.16` production deployment is claimed. Fresh read-only access recheck run `35475064743` attempt 2 is **BLOCKED_EXTERNAL_ACCESS** before WordPress authentication: TCP/443 connects, TLS stalls after ClientHello on each observed IPv4 backend, and Playwright cannot reach `wp-login.php`; WPVibe fallback was simultaneously rate-limited. Production remained unmodified. Fresh live Theme version remains UNKNOWN and `1.3.10` remains only the last verified state until one secure authenticated read path succeeds. Evidence: `docs/evidence/V1_3_16_LSTAMDUCHN_PRODUCTION_ACCESS_BLOCKED_20260920.md`.
