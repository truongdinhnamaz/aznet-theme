...
- Rèm 01 production checkpoint — owner-approved PR #262/#263 Process Rail + Project Showcase remains retained, and owner-approved PR #266 adds the Theme-owned three-image Hero performance correction through canonical `main@9b93fd76f7d3238734bec58e247bf98d61851618`, Theme metadata `1.3.31`. Exact-main V1 run `35888794704`, X6 run `35888794683` and dedicated Project Showcase run `35888794974` completed SUCCESS after the merge. On `remquocanh.vn`, WordPress still owns Hero block #991 and Media #669/#670/#671, Process Page #997, Project Post #999 / Category #80 and the other mapped content sources; Theme remains presentation/composition owner only. PR #266 was proven RED -> GREEN, then published from a WPVibe draft after owner preview/approval with `aznet-theme-wpvibe-backup` retained as immediate theme-file rollback. Fresh production readback confirms Theme `1.3.31`, `data-aznet-curtain-slide-count="3"`, primary Hero image eager/high priority, secondary images lazy/low priority, and intrinsic/responsive image metadata. Fresh mobile Lighthouse after publication is Performance 86, LCP 4.2 s, CLS 0, TBT 0 ms, FCP 1.2 s and Speed Index 2.3 s; lab data only, with no CrUX field data. Current published GitHub Release remains `v1.3.23`; provider L5, independent external pixel-level L4 and dedicated public-host Vietnamese font loaded-state verification remain separate/UNKNOWN. Evidence: `docs/evidence/CURTAIN01_PROJECT_SHOWCASE_PRODUCTION_20260923.md` and `docs/evidence/CURTAIN01_HERO_PERFORMANCE_PRODUCTION_20260924.md`.
...
- Production deployment is separate from repository technical verification and GitHub publication. D-033 remains authoritative: no production-site connector, including WPVibe, is a mandatory dependency for creating, verifying or publishing an installable AZnet Theme release. No `1.3.23` production mutation is claimed by this release checkpoint.
