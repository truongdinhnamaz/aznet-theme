...
- Current canonical service-page/release technical baseline: owner-approved service presentation PR #199 merged to `main@cbedacc1225cab2fdacbe11483bd746545378619`; owner-approved release PR #200 promoted Theme metadata to `1.3.22` and merged to canonical `main@7ea9a189b124482b495f6e2adff668c070ff94de`. Fresh exact-main V1 run `35521042638` and X6 run `35521042601` both completed SUCCESS. X6 browser/axe, runtime, package/source identity and rollback lifecycle passed; deterministic `aznet-theme-1.3.22.zip` has 159 production files, 113 packaged PHP files verified and SHA-256 `d5197073641ebc6b7764ffca31409b56cf9e447d533899999db94b28d5e02790`. X6 artifact `10608505607` has digest `sha256:a8d8a2cee65e8debf91191cf422d47f655c56117d8b8ea19cd4889485732f616`. Evidence: `docs/evidence/V1_3_22_SERVICE_PAGE_RELEASE_20260920.md`.
...
- Current published GitHub Release is `v1.3.22`: annotated tag object `a552ee75f05ff1b8f9733137d2015692a20e565d` dereferences to exact canonical implementation `7ea9a189b124482b495f6e2adff668c070ff94de`; Release `392486195`; asset `577094851` `aznet-theme-1.3.22.zip`, SHA-256 `d5197073641ebc6b7764ffca31409b56cf9e447d533899999db94b28d5e02790`. Publication run `35521247319` completed SUCCESS; evidence artifact `10608601176` digest `sha256:03f1e3965173e284ca9bd18a21550a8524ee6410dbac89cdb9d288ae9f53698c`. Evidence: `docs/evidence/V1_3_22_SERVICE_PAGE_RELEASE_20260920.md`.
- Current production target remains `lstamduchn.vn`. No `1.3.22` production deployment is claimed. Fresh WPVibe account readback on 20/09/2026 confirms the site remains connected, but the rolling 24-hour allowance is exhausted at 550/500 calls with 0 remaining and more usage expected around 21/09/2026 03:40 UTC. Authenticated production preflight/deployment is therefore **BLOCKED_EXTERNAL_ACCESS** without any production mutation. Fresh live Theme version remains UNKNOWN and `1.3.10` remains only the last verified live state until a secure authenticated read succeeds.
