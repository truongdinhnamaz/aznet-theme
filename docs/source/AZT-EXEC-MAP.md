...
> **Canonical-main checkpoint:** exact current canonical `main` is `6bcdc918a6ec5286ced572b4fd86491adf28f207`, Theme metadata `1.3.54`. PR #276/#277/#278 are integrated. Direct exact-main L1/L2 source verification for the D-041 completeness correction PASS with 0 failures; L3/L4 remain UNKNOWN.
...
| F Homepage | CORE PASS / LAW 01 FINAL PASS / v1.3.20 PUBLISHED / F9 PROVIDER L5 RETAINED | Native Homepage remains core PASS. Law 01 premium Homepage is final-owner-approved after PR #193 + exact-main `1.3.20` verification/publication. ConvertFlow F9 provider L5 remains retained at its separately certified scope. RootProfile-backed Team projection remains separate external blocker #112; no ownership transfer is inferred. |
...
- Final Homepage owner approval: **PASS** for the reviewed Law 01 Burgundy Homepage presentation.
- Premium Homepage PR #193 final head `77b642bbbd2d34d43215fb69d77121484ff4fca3` completed all 16 triggered workflows SUCCESS; Homepage Composer browser quality run `35503321766` passed the 1920/1440/1024/390/320 matrix with no horizontal overflow, blocking axe violations or browser/runtime failures.
- PR #193 merged to `main@0a66d5b5e30cb91c6f61d593ca950e43eec6ee10`. Release PR #194 then promoted exact Theme metadata `1.3.20` and merged to canonical `main@a81067b1f1804783a35e8113ebf6859c7fcc38fa`.
- Exact-main V1 `35509805662`: SUCCESS. Exact-main X6 `35509805668`: SUCCESS. X6 deterministic package: `aznet-theme-1.3.20.zip`, 158 files, SHA-256 `96ff01960e17d1da7167c5c3e296abbdabad0e5d51603f0f73ca4513ac880c00`; exact package/source identity, packaged PHP verification and rollback lifecycle PASS.
- Published release: annotated `v1.3.20` object `f7d50863b3b7b8f4e500172ba624d24b73ff312f` -> exact canonical implementation; GitHub Release `392420684`; asset `576757385` with matching SHA-256.
- Publication run `35509995234`: SUCCESS; evidence artifact `10605040189`, digest `sha256:e6852b61a14c176db5f7da28c063fe204140cdeeba4eb8440902bc2cd91a52b8`.
- Homepage ownership remains clean: Theme owns presentation/composition only; WordPress/public-safe mapped sources own authored content; mappings fail soft; no private provider storage, heuristic identity/source discovery or domain takeover.
...
## 15.12 AZnet Theme 1.3.10 publication closure — 19/09/2026

- Owner approval: release 1.3.10.
- Exact implementation target: `39df23c3385118888e262c27a2331de34dda430d`.
- Publication-time main: `e9133708713671584731c002f4d2947ea7adbbde`, docs-only delta from target.
- Publication workflow: `35413516574` — SUCCESS.
- Package: `aznet-theme-1.3.10.zip`, 145 production files, 108/108 packaged PHP lint.
- Published SHA-256: `5ff6c4862839dcdb6dfbbb77a71cb8bd87259b83cfbf308aa6b04279396bd572`.
- Annotated tag object: `c4d295acb6e849415ac5a228656e361660298e12` -> `39df23c...`.
- GitHub Release: `391877350`; asset: `573847909`.
...
- Settings storage remains the existing `aznet_theme_settings` schema v3; no migration store/version bump is required for the additive keys.
...
- Publication run `35474494290`: SUCCESS.
- Annotated tag `v1.3.15` object `a0895fc339b1020d7147b00eac243340691fde23` -> exact implementation.
- GitHub Release `392243619`; asset `575623879` `aznet-theme-1.3.15.zip`.
- Asset SHA-256 `8f91e9bd3a40a7eae4e6984a77f2735f339d188e52cfc6f97fac57a96bfcecd8`; 148 production files; 111 packaged PHP files.
- Publication evidence artifact `10593402386`, digest `sha256:cf35664008ef75b2a93dca455e14987c571949e826d0bda97b000ad86f6dff67`.
- Temporary workflow cleanup `efcfa1cd3a64470808f98d01ec9911dddd87298b`; zero net file delta against publication-time `main@79fcf11f043129a4ce82629a77fc1267802b2bba`.
- State: **v1.3.15 TECHNICAL PASS / PUBLICATION PASS / PRODUCTION DEPLOYMENT GATED**.
- Fresh post-publication live readback: UNKNOWN due external WPVibe daily fair-use cap; prior Theme `1.3.10` is last verified live state only.
...
| Slice | State | Exact boundary |
| --- | --- | --- |
| HB0 Governance | PASS / canonical | D-041 shared-model/admin UX decision recorded and integrated through PR #276 |
...
**Current exact next:** preserve canonical D-041 L1/L2 PASS on `main@6bcdc918a6ec5286ced572b4fd86491adf28f207`. L3 WordPress runtime and L4 browser/a11y remain UNKNOWN; release/deployment stay separately gated.
