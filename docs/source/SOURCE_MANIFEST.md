...
| `AZT-04-roadmap-qa-decisions.md` | v0.35 | R0-R6/P2-P3/P4-A/P4-B PASS, D-027/P4-C Standalone Core exact next, P4 pilot access-blocked, P5 gates and D-001..D-027 |
| `AZT-EXEC-MAP.md` | v0.27 | Derived execution map with canonical PR #58 checkpoint and D-027/P4-C exact next |
