...
require_once __DIR__ . '/provisioning-indexing.php';
...
require_once __DIR__ . '/law01-reference.php';
...
add_action( 'wp_enqueue_scripts', __NAMESPACE__ . '\\enqueue_law01_reference_asset', 20 );
