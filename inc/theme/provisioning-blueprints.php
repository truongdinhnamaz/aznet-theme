...
function provisioning_blueprint( string $key ): ?array {
    ...
    $blueprint = [
        ...
        'pages' => [
            ...
            'team' => $page('Đội ngũ của chúng tôi','Giới thiệu đội ngũ và vai trò chuyên môn thực tế của tổ chức.','<p>Hãy thêm nhân sự thật bằng các Page con của trang này. AZnet Theme không tạo người, chức vụ hoặc thành tích mẫu.</p>'),
