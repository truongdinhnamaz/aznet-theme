...
<!-- wp:paragraph {"metadata":{"name":"aznet-hero-eyebrow"},"className":"aznet-theme-homepage-hero-content__eyebrow","lock":{"move":true,"remove":true}} -->
<p class="aznet-theme-homepage-hero-content__eyebrow"><?php esc_html_e( 'Thông điệp mở đầu', 'aznet-theme' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:heading {"metadata":{"name":"aznet-hero-title"},"level":1,"className":"aznet-theme-homepage-hero-content__title","lock":{"move":true,"remove":true}} -->
...
<!-- /wp:heading -->
<!-- wp:paragraph {"metadata":{"name":"aznet-hero-value"},"className":"aznet-theme-homepage-hero-content__value","lock":{"move":true,"remove":true}} -->
<p class="aznet-theme-homepage-hero-content__value"><?php esc_html_e( 'Viết dòng giá trị chính của Hero.', 'aznet-theme' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"metadata":{"name":"aznet-hero-lead"},"className":"aznet-theme-homepage-hero-content__lead","lock":{"move":true,"remove":true}} -->
<p class="aznet-theme-homepage-hero-content__lead"><?php esc_html_e( 'Viết thông điệp hoặc khẩu hiệu hỗ trợ.', 'aznet-theme' ); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:button {"metadata":{"name":"aznet-hero-primary-cta"},"backgroundColor":"primary","lock":{"move":true,"remove":true}} -->
...
<!-- /wp:button -->
<!-- wp:button {"metadata":{"name":"aznet-hero-secondary-cta"},"className":"is-style-outline aznet-theme-homepage-hero-content__secondary","lock":{"move":true,"remove":true}} -->
...
<!-- /wp:column -->
<!-- wp:column {"metadata":{"name":"aznet-hero-media"},"verticalAlignment":"center","className":"aznet-theme-homepage-hero-content__media","lock":{"move":true,"remove":true}} -->
...
<div class="wp-block-column"><!-- wp:paragraph {"metadata":{"name":"aznet-hero-trust-1"},"className":"aznet-theme-homepage-hero-content__trust-item"} --><p class="aznet-theme-homepage-hero-content__trust-item"><?php esc_html_e( 'Tư vấn rõ ràng', 'aznet-theme' ); ?></p><!-- /wp:paragraph --></div>
<!-- /wp:column -->
<!-- wp:column {"lock":{"move":true,"remove":true}} -->
<div class="wp-block-column"><!-- wp:paragraph {"metadata":{"name":"aznet-hero-trust-2"},"className":"aznet-theme-homepage-hero-content__trust-item"} --><p class="aznet-theme-homepage-hero-content__trust-item"><?php esc_html_e( 'Giải pháp thực tiễn', 'aznet-theme' ); ?></p><!-- /wp:paragraph --></div>
<!-- /wp:column -->
<!-- wp:column {"lock":{"move":true,"remove":true}} -->
<div class="wp-block-column"><!-- wp:paragraph {"metadata":{"name":"aznet-hero-trust-3"},"className":"aznet-theme-homepage-hero-content__trust-item"} --><p class="aznet-theme-homepage-hero-content__trust-item"><?php esc_html_e( 'Bảo mật thông tin', 'aznet-theme' ); ?></p><!-- /wp:paragraph --></div>
<!-- /wp:column -->
<!-- wp:column {"lock":{"move":true,"remove":true}} -->
<div class="wp-block-column"><!-- wp:paragraph {"metadata":{"name":"aznet-hero-trust-4"},"className":"aznet-theme-homepage-hero-content__trust-item"} --><p class="aznet-theme-homepage-hero-content__trust-item"><?php esc_html_e( 'Đồng hành tận tâm', 'aznet-theme' ); ?></p><!-- /wp:paragraph --></div>
<!-- /wp:column -->
</div>
<!-- /wp:columns -->
</div>
