...
<div class="aznet-theme-law01-faq__layout">
<div class="aznet-theme-law01-faq__copy">
...
<p class="aznet-theme-law01-faq__action"><a class="aznet-theme-law01-button aznet-theme-law01-button--secondary" href="<?php echo esc_url( get_permalink( $page ) ); ?>"><?php esc_html_e( 'Xem câu hỏi thường gặp', 'aznet-theme' ); ?> <span aria-hidden="true">→</span></a></p>
</div>
</div>
</section>
