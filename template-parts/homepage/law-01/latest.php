...
<div class="aznet-theme-law01-section-heading"><div><p class="aznet-theme-law01-eyebrow"><?php esc_html_e( 'Kiến thức pháp luật', 'aznet-theme' ); ?></p><h2 id="aznet-law01-latest-title"><?php esc_html_e( 'Bài viết mới nhất', 'aznet-theme' ); ?></h2></div><?php if ( '' !== $posts_page_url ) : ?><a class="aznet-theme-law01-text-link" href="<?php echo esc_url( $posts_page_url ); ?>"><?php esc_html_e( 'Xem tất cả bài viết', 'aznet-theme' ); ?> <span aria-hidden="true">→</span></a><?php endif; ?></div>
...
<div class="aznet-theme-law01-article-card__body"><div class="aznet-theme-law01-article-card__meta"><?php if ( [] !== $categories ) : ?><span><?php echo esc_html( $categories[0]->name ); ?></span><?php endif; ?><time datetime="<?php echo esc_attr( get_the_date( 'c', $post ) ); ?>"><?php echo esc_html( get_the_date( '', $post ) ); ?></time></div><h3><a href="<?php echo esc_url( get_permalink( $post ) ); ?>"><?php echo esc_html( get_the_title( $post ) ); ?></a></h3><?php $excerpt = trim( (string) get_the_excerpt( $post ) ); if ( '' !== $excerpt ) : ?><p><?php echo esc_html( $excerpt ); ?></p><?php endif; ?><span class="aznet-theme-law01-text-link" aria-hidden="true"><?php esc_html_e( 'Đọc thêm', 'aznet-theme' ); ?> <span aria-hidden="true">→</span></span></div>
