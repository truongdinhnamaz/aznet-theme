...
foreach(['Nguồn này hiện cũng được mẫu','Tạo nguồn riêng cho mẫu này','homepage_shared_source_uses'] as $needle) assert(str_contains($source,$needle),"Missing shared-source warning: {$needle}");
