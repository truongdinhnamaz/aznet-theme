...
$workflow = $root . '/.github/workflows/_ops-tamduc-v1-3-postdeploy-verify.yml';
$browser = $root . '/tests/browser/tamduc-v1-3-postdeploy-verify.mjs';
...
foreach ([
    ...
    '[verify-tamduc-v1.3.0]',
    'PILOT_WP_USER',
    'PILOT_WP_PASSWORD',
    'tests/browser/tamduc-v1-3-postdeploy-verify.mjs',
...
echo "PASS: Tam Duc v1.3.0 post-deploy read-only contract\n";
