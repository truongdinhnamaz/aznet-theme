...
$required = [
    ...
    "echo 'PASS: X6 promoted 1.3.18 ownership boundary'",
    "echo 'PASS: X6 promoted 1.3.19 ownership boundary'",
    "echo 'PASS: X6 promoted 1.3.20 ownership boundary'",
    "echo 'PASS: X6 promoted 1.3.21 ownership boundary'",
    "echo 'PASS: X6 promoted 1.3.22 ownership boundary'",
    "echo 'PASS: X6 promoted 1.3.23 ownership boundary'",
    "echo 'PASS: X6 promoted 1.3.24 ownership boundary'",
    ...
    "echo 'FAIL: X6 promoted metadata diff exceeds approved 1.3.18 boundary' >&2",
    "echo 'FAIL: X6 promoted metadata diff exceeds approved 1.3.19 boundary' >&2",
    "echo 'FAIL: X6 promoted metadata diff exceeds approved 1.3.20 boundary' >&2",
    "echo 'FAIL: X6 promoted metadata diff exceeds approved 1.3.21 boundary' >&2",
    "echo 'FAIL: X6 promoted metadata diff exceeds approved 1.3.22 boundary' >&2",
    "echo 'FAIL: X6 promoted metadata diff exceeds approved 1.3.23 boundary' >&2",
    "echo 'FAIL: X6 promoted metadata diff exceeds approved 1.3.24 boundary' >&2",
