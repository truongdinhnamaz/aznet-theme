...
$builder = x6_read('scripts/build-release-package.py');
if (! str_contains($builder, "'node_modules'")) {
    x6_fail('release package builder must exclude transient node_modules from every candidate');
}
