...
$must( 1 === preg_match( '/^Version:\s*1\.3\.13\s*$/m', $style ), 'Y5 promoted style.css must be exactly 1.3.13' );
$must( str_contains( $functions, "define( 'AZNET_THEME_VERSION', '1.3.13' );" ), 'Y5 promoted AZNET_THEME_VERSION must be exactly 1.3.13' );
